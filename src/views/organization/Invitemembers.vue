<template>
  <div class="Invitemembers">
    <p class="alertinfo">将链接发给小伙伴就可以啦</p>
    <div class="copylink">
      <input type="text" class="copyinput" :value="CopyUrl" disabled/>
      <button
        type="button"
        class="copybtn"
    ...
    <p class="footerinfo">邀请有效期为14天，过期后项目成员仍可打开</p>
  </div>
</template>
<script>
export default {
  ...
  data() {
    return {
      CopyUrl: "https://leboxinrui.com/url/BCMFD-CKc6h"
    };
  },
  mounted(){
